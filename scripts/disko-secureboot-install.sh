...
flake_dir_name=$(basename "${flake_dir}")
target_host="${1:-}"
target_user="${2:-bazyli}"
target_config_dir="${MOUNT_DIR}/home/${target_user}/${flake_dir_name}"
...
echo -e "${BLUE}Copying the config to '${target_config_dir}'${ENDCOLOR}"
